...
<script lang="ts">
    ...
    export default class MineRelease extends Vue {
        // 当前列表数据
         ...
         * 获取数据
         */
        private async findMineRelease(type=0): void {
        ...
        private async likeArticle(params: object): void {
            ...
            code === 200 && this.findMineRelease(2)
